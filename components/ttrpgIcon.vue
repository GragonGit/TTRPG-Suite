<template>
<svg v-if="iconName === 'moon'" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
...
<svg v-if="iconName === 'sun'" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
  <path fill="currentColor"
...
<svg v-if="iconName === 'ttrpgSuite'" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
  <path fill="currentColor"
    d="M0 28 v-10 l5 5 l14.5 -14.5 l6.5 6.5 l6 -6 v20" />
</svg>
</template>
